...
namespace CluedIn.Crawling.AzureDataLake.Infrastructure.Installers
{
    public class InstallComponents : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            container
                ...
                .Register(Component.For<IAzureDataLakeClientFactory>().AsFactory())
                .Register(Component.For<AzureDataLakeClient>().LifestyleTransient());
