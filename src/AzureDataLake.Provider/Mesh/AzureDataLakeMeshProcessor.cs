...
{
    public class AzureDataLake_Command_MeshProcessor : BaseMeshProcessor
    {
        public AzureDataLake_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          AzureDataLakeConstants.ProviderId;
